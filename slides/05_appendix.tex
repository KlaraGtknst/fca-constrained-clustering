...
\begin{itemize}
    \item Standard \ac{fca} closure operators works on flat implications (i.e., $d_x \wedge d_z \rightarrow d_y$)
    \item Hierarchy implies structural transitivity 
    \item[\danger] Transitive implications not naturally listed
    \item[$\rightarrow$] Structural saturation: Explicitly add implicit transitive inference rules
    \item Closure operator $\phi_{\Sigma}$ is applied to updated implication set
\end{itemize}
