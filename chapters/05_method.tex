...
Besides existing file structures, we employed external knowledge bases such as WordNet and topic models for enriching the dataset with categories.

\subsubsection{WordNet}
Synsets etc.~\cite{fellbaum2010wordnet}

\subsubsection{Topic Models}
We employed gensim's LDA