...
To validate the quality of our topic model-derived context, we compare it against ground truth labels when available. 
% Figure~\ref{fig:context_comparison} presents a comparative analysis of the incidence properties.
