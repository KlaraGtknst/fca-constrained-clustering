...
Based on this analysis, we select $\text{min\_supp} = 0.05$ to balance hierarchy richness with conceptual interpretability, yielding approximately 30 concepts for the BankSearch dataset.
