...
Similarity-based is 2D representation, where dimensions are not explicitely interpretable (unlike with object-attribute descirption). Distances in this space have a semantic meaning. (\textcolor{orange}{Stefan knows more})}
