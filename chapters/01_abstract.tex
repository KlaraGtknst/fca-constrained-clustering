...
Hierarchical expert knowledge can additionally be encoded through \ac{mlb} constraints in constrained clustering.
However, when hierarchies are derived from different knowledge sources, it remains unclear how their agreement can be quantified systematically.
...
% second contribution
Building on this result, we introduce a method for comparing concept lattices derived from \acs{mlb} constraints and from data-driven topic models. 
% case study
