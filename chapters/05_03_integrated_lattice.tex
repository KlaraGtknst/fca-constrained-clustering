\subsection{Consistency-Lattices}
...
We denote the concept lattice derived from $\mathbb{K}_{merged}$ as the \textit{consistency}-lattice, as it represents the hierarchy of concepts that are consistent with both the expert knowledge and the empirical data.