...
To obtain the concept lattices' dendrogram consistent with the implications encoded in the context, extract \ac{mlb} constraints from the lattice structure (cf. \autoref{sec:foundations_mlb}) and apply them to a hierarchical clustering algorithm, such as \ac{hac} or \ac{ihac}.
