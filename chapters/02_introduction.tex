...
\textcolor{red}{TODO: 
% Beyond ontology induction, \ac{fca} has been used to uncover and explain semantic and conceptual structures in lexical resources such as Roget's Thesaurus~\cite{old:04,Priss:2004} and FrameNet~\cite{val:05}.
Beyond ontology induction, \ac{fca} has been applied to the analysis and explanation of semantic structures in lexical resources, for example by modeling lexical databases and thesauri~\cite{Priss:2004,old:04}, explaining the organization of FrameNet through concept lattices~\cite{val:05}, discovering sentiment structures in social media data~\cite{GalnPez2014DiscoveringNS}, and supporting knowledge discovery in domains such as domestic violence detection~\cite{Elzinga2009DetectingDV}.
TODO: \cite{priss:98} phd thesis \cite{Priss:96}
}
