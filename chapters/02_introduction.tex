...
\textcolor{red}{TODO: 
Beyond ontology induction, \ac{fca} and relational concept analysis have been used to model and analyze semantic structures in lexical resources and knowledge bases, including WordNet~\cite{Priss:96,priss:98}, lexical databases and Roget's Thesaurus~\cite{Priss:2004,old:04}, and FrameNet through concept lattices~\cite{val:05}. FCA has furthermore been applied to knowledge discovery tasks such as sentiment structure induction from social media data~\cite{GalnPez2014DiscoveringNS} and domestic violence detection~\cite{Elzinga2009DetectingDV}.
}
