...
For unstructured text corpora, formal contexts must first be derived from textual information using methods ranging from pattern-based extraction~\cite{hearst1992hyponyms,le2019inferring} to multi-step \acl{nlp} pipelines that construct binary object-attribute contexts~\cite{cimiano_learning_2005}, as well as approaches using phrases directly as attributes~\cite{Elzinga:09}.
