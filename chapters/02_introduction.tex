...
\textcolor{orange}{Since each concept is characterized by an explicit set of shared attributes, the resulting hierarchy provides transparent, attribute-based explanations of the relationships between concepts, making \ac{fca}-based hierarchies inherently interpretable compared to similarity-based clustering methods}.
...
We address this gap by incorporating \ac{mlb} constraints into the \ac{fca} framework to guide the construction of concept hierarchies (Section~\ref{sec:method}),\footnote{The code is available at \url{github.com/KlaraGtknst/fca-constrained-clustering}} \textcolor{orange}{thereby extending prior work that incorporates pairwise constraints}~\cite{belohlavek2011selecting}.
